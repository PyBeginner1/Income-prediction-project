...
from income.constant import CONFIG_DIR, get_current_time_stamp
from income.pipeline.pipeline import Pipeline
from income.entity.income_predictor import IncomePredictor, IncomeData
from flask import send_file, abort, render_template
from income.logger import get_log_dataframe
...
INCOME_DATA_KEY = "income_prediction_data"
...
def predict():
    ...
    if request.method == 'POST':
        ...
        income_prediction_data = IncomeData(longitude=longitude,
                                   latitude=latitude,
        ...
        income_prediction_predictor = IncomePredictor(model_dir=MODEL_DIR)
        median_income_prediction_value = income_prediction_predictor.predict(X=income_prediction_df)
        context = {
            INCOME_DATA_KEY: income_prediction_data.get_income_prediction_data_as_dict(),
