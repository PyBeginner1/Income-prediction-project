...
from income.entity.artifact_entity import DataValidationArtifact, DataIngestionArtifact
import os,sys
    ...
    def is_train_test_file_exists(self) -> bool:
        try:
            ...
            if not is_available:
                ...
                test_file_path = self.data_ingestion_artifact.test_file_path
                logging.info(f'Training file: [{training_file_path}] or Testing file: [{test_file_path}] is not available')
                raise Exception(f'Training file: [{training_file_path}] or Testing file: [{test_file_path}] is not available')
