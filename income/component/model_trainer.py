...
from income.util.util import load_numpy_array_data,save_object,load_object
from income.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from income.entity.model_factory import evaluate_regression_model
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            housing_model = IncomeEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
    ...
    #My code
    def initiate1_model_trainer(self) -> ModelTrainerArtifact:
        try:
            logging.info(f"Loading transformed training dataset")
            transformed_train_file_path = self.data_transformation_artifact.transformed_train_file_path
            train_array = load_numpy_array_data(file_path=transformed_train_file_path)
